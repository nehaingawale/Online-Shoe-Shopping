<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="onlineshop.admin.login" %>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtuname" runat="server" placeholder="Enter User Name" CssClass="txt" 
                        ontextchanged="txtuname_TextChanged" Width="120px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="lbl">
